namespace PCSX2Bonus
{
    ...
    {
        private static FontFamilyConverter _fontConverter = new FontFamilyConverter();
        private static FontWeightConverter _fontWeightConverter = new FontWeightConverter();
        private static SizeConverter _sizeConverter = new SizeConverter();
        private static XElement _themeXel = Tools.TryLoad(Path.Combine(UserSettings.ThemesDir, Settings.Default.defaultTheme));
        ...
        {
            XElement element2 = _themeXel.Element(element);
            if (element2 == null)
            {
                return "";
            }
            if (element2.Attribute(attribute) == null)
            {
                return "";
            }
            return _themeXel.Element(element).Attribute(attribute).Value;
        }
        ...
        public static string FilePath
        {
            ...
            get
            {
                return <FilePath>k__BackingField;
            }
            [CompilerGenerated]
            set
            {
                <FilePath>k__BackingField = value;
            }
        }
    }
}
